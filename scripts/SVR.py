...
for i in range(len(pred_int)):
    if (abs(y_test_int[i] - pred_int[i]) > 2):
        print(y_test_int[i], pred_int[i])
...
print("With int output")
print("R2 score:\t\t", r2_score(y_rand, pred_int))
print("Explained Var:\t\t", explained_variance_score(y_rand, pred_int))
print("Mean Absolute Error:\t", mean_absolute_error(y_rand, pred_int))
print("Mean Squared Error:\t", mean_squared_error(y_rand, pred_int))
print("Mean Squared Log Error:\t", mean_squared_log_error(y_rand, pred_int))
print("Median Absolute Error:\t", median_absolute_error(y_rand, pred_int))
print("Accuracy:\t", accuracy_score(y_rand, pred_int))